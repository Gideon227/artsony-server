...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly artwork_availability: readonly ["available", "sold", "reserved", "not_for_sale"];
            readonly artwork_category: readonly ["painting", "digital", "photography", "sculpture", "illustration", "mixed_media", "print", "other"];
            readonly artwork_format: readonly ["DIGITAL", "PHYSICAL"];
            readonly artwork_media_type: readonly ["IMAGE", "VIDEO", "THREE_D", "EXTERNAL_LINK"];
            readonly artwork_status: readonly ["DRAFT", "PUBLISHED", "ARCHIVED", "UNDER_REVIEW", "PAUSED"];
            readonly artwork_visibility: readonly ["PUBLIC", "PRIVATE", "UNLISTED"];
            readonly auth_provider: readonly ["local", "google", "facebook"];
            readonly conversation_type: readonly ["direct", "broadcast"];
            readonly listing_type: readonly ["MARKETPLACE", "PORTFOLIO"];
            readonly message_type: readonly ["text", "image", "system"];
            readonly moderation_status: readonly ["PENDING", "APPROVED", "REJECTED", "FLAGGED"];
            readonly notification_type: readonly ["like", "comment", "follow", "mention", "reply", "sale", "system", "message", "broadcast"];
            readonly order_status: readonly ["PENDING_PAYMENT", "PAYMENT_CONFIRMED", "PROCESSING", "SHIPPED", "FULFILLED", "COMPLETED", "CANCELLED", "REFUNDED"];
            readonly participant_role: readonly ["owner", "member"];
            readonly seller_registration_status: readonly ["PENDING", "APPROVED", "REJECTED", "SUSPENDED"];
            readonly transaction_status: readonly ["PENDING", "CONFIRMING", "CONFIRMED", "FAILED", "EXPIRED"];
            readonly user_role: readonly ["USER", "ARTIST", "MODERATOR", "ADMIN"];
            readonly user_status: readonly ["ACTIVE", "SUSPENDED", "DELETED"];
            readonly wallet_ledger_entry_type: readonly ["CREDIT", "DEBIT"];
            readonly wallet_network: readonly ["TRON", "ETHEREUM", "BSC"];
        };
    };
};
export {};
